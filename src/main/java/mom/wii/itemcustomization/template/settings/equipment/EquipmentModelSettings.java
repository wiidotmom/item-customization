...
public class EquipmentModelSettings {
    public static void openRootDialog(ServerPlayer player) {
        ...
        ItemCustomization.EQUIPMENT_MODEL_INDEX.namespaces.forEach(namespace -> {
            buttons.add(new ActionButton(
                    ...
                    Optional.of(new StaticAction(
                            new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "equipment_model/namespace"), Optional.of(StringTag.valueOf(namespace)))
                    ))
            ));
        });
        ...
        MultiActionDialog dialog = new MultiActionDialog(
                new CommonDialogData(
                        Component.translatableWithFallback("gui.igalaxy_item_customization.equipment_model.title", "Equipment Model"),
                        Optional.empty(),
                        true,
                        true,
    ...
    public static void openDialogForNamespaceAndPath(ServerPlayer player, String namespace, String path) {
        ...
        ArrayList<ActionButton> buttons = new ArrayList<>();
        for (Identifier identifier : ItemCustomization.EQUIPMENT_MODEL_INDEX.getIdentifiersOfNamespaceAndPath(namespace, path)) {
            ...
            buttons.add(new ActionButton(
                    ...
                    Optional.of(new StaticAction(
                            isDirectory ?
                                    new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "equipment_model/browse"), Optional.of(StringTag.valueOf(identifier.toString()))) :
                                    new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "equipment_model/set"), Optional.of(StringTag.valueOf(identifier.toString())))
                    ))
            ));
        }
        ...
        MultiActionDialog dialog = new MultiActionDialog(
                new CommonDialogData(
                        ...
                        DialogAction.WAIT_FOR_RESPONSE,
                        List.of(
                                new ItemBody(SEARCH_ICON, Optional.of(new PlainMessage(Component.translatableWithFallback("gui.igalaxy_item_customization.equipment_model.select_model", "Select an equipment model"), 200)), false, false, 16, 16),
                                new PlainMessage(Component.literal("/assets/").withStyle(ChatFormatting.GRAY).append(Component.literal(namespace).withStyle(ChatFormatting.WHITE).append(Component.literal("/equipment/").withStyle(ChatFormatting.GRAY)).append(Component.literal(path).withStyle(ChatFormatting.WHITE))), 200)
                        ),
                        List.of()
                ),
                buttons,
                Optional.of(
                        new ActionButton(
                                ...
                                Optional.of(new StaticAction(
                                        parentDir.isEmpty() ?
                                                new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "equipment_model"), Optional.empty()) :
                                                new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "equipment_model/browse"), Optional.of(StringTag.valueOf(parentDir.get().toString())))
                                ))
                        )
                ),
                3
