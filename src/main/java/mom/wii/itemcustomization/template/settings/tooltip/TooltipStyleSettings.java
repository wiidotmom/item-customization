    ...
    public static void openRootDialog(ServerPlayer player) {
        ...
        ItemCustomization.TOOLTIP_STYLE_INDEX.namespaces.forEach(namespace -> {
            buttons.add(new ActionButton(
                    ...
                    Optional.of(new StaticAction(
                            new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "tooltip_style/namespace"), Optional.of(StringTag.valueOf(namespace)))
                    ))
            ));
        });
        ...
        MultiActionDialog dialog = new MultiActionDialog(
                new CommonDialogData(
                        Component.translatableWithFallback("gui.igalaxy_item_customization.tooltip_style.title", "Tooltip Style"),
                        Optional.empty(),
                        true,
                        true,
    ...
    public static void openDialogForNamespaceAndPath(ServerPlayer player, String namespace, String path) {
        ...
        for (Identifier identifier : ItemCustomization.TOOLTIP_STYLE_INDEX.getIdentifiersOfNamespaceAndPath(namespace, path)) {
            ...
            buttons.add(new ActionButton(
                    ...
                    Optional.of(new StaticAction(
                            isDirectory ?
                                    new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "tooltip_style/browse"), Optional.of(StringTag.valueOf(identifier.toString()))) :
                                    new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "tooltip_style/set"), Optional.of(StringTag.valueOf(identifier.toString())))
                    ))
            ));
        }
        ...
        MultiActionDialog dialog = new MultiActionDialog(
                new CommonDialogData(
                        ...
                        DialogAction.WAIT_FOR_RESPONSE,
                        List.of(
                                new ItemBody(SEARCH_ICON, Optional.of(new PlainMessage(Component.translatableWithFallback("gui.igalaxy_item_customization.tooltip_style.select_style", "Select a tooltip style"), 200)), false, false, 16, 16),
                                new PlainMessage(Component.literal("/assets/").withStyle(ChatFormatting.GRAY).append(Component.literal(namespace).withStyle(ChatFormatting.WHITE).append(Component.literal("/textures/gui/sprites/tooltip/<style>_(frame|background).png").withStyle(ChatFormatting.GRAY)).append(Component.literal(path).withStyle(ChatFormatting.WHITE))), 200)
                        ),
                        List.of()
                ),
                buttons,
                Optional.of(
                        new ActionButton(
                                ...
                                Optional.of(new StaticAction(
                                        parentDir.isEmpty() ?
                                                new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "tooltip_style"), Optional.empty()) :
                                                new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "tooltip_style/browse"), Optional.of(StringTag.valueOf(parentDir.get().toString())))
                                ))
                        )
                ),
                3
