...
public class InstrumentSettings {
    public static void openRootDialog(ServerPlayer player) {
        ...
        ItemCustomization.INSTRUMENT_INDEX.namespaces.forEach(namespace -> {
            buttons.add(new ActionButton(
                    ...
                    Optional.of(new StaticAction(
                            new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "instrument/namespace"), Optional.of(StringTag.valueOf(namespace)))
                    ))
            ));
        });
        ...
        MultiActionDialog dialog = new MultiActionDialog(
                new CommonDialogData(
                        Component.translatableWithFallback("gui.igalaxy_item_customization.instrument.title", "Instrument"),
                        Optional.empty(),
                        true,
                        true,
    ...
    public static void openDialogForNamespaceAndPath(ServerPlayer player, String namespace, String path) {
        ...
        ArrayList<ActionButton> buttons = new ArrayList<>();
        for (Identifier identifier : ItemCustomization.INSTRUMENT_INDEX.getIdentifiersOfNamespaceAndPath(namespace, path)) {
            ...
            buttons.add(new ActionButton(
                    ...
                    Optional.of(new StaticAction(
                            isDirectory ?
                                    new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "instrument/browse"), Optional.of(StringTag.valueOf(identifier.toString()))) :
                                    new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "instrument/set"), Optional.of(StringTag.valueOf(identifier.toString())))
                    ))
            ));
        }
        ...
        MultiActionDialog dialog = new MultiActionDialog(
                new CommonDialogData(
                        ...
                        DialogAction.WAIT_FOR_RESPONSE,
                        List.of(
                                new ItemBody(SEARCH_ICON, Optional.of(new PlainMessage(Component.translatableWithFallback("gui.igalaxy_item_customization.instrument.select_instrument", "Select an instrument"), 200)), false, false, 16, 16),
                                new PlainMessage(Component.literal("/data/").withStyle(ChatFormatting.GRAY).append(Component.literal(namespace).withStyle(ChatFormatting.WHITE).append(Component.literal("/instrument/").withStyle(ChatFormatting.GRAY)).append(Component.literal(path).withStyle(ChatFormatting.WHITE))), 200)
                        ),
                        List.of()
                ),
                buttons,
                Optional.of(
                        new ActionButton(
                                ...
                                Optional.of(new StaticAction(
                                        parentDir.isEmpty() ?
                                                new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "instrument"), Optional.empty()) :
                                                new ClickEvent.Custom(Identifier.fromNamespaceAndPath(ItemCustomization.MOD_ID, "instrument/browse"), Optional.of(StringTag.valueOf(parentDir.get().toString())))
                                ))
                        )
                ),
                3
